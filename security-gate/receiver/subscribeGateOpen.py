...
parser = argparse.ArgumentParser(description="Send and receive messages through and MQTT " +
                                "connection.")
parser.add_argument('--endpoint', default=endpoint, required=True, help="Your AWS IoT custom " +
...
parser.add_argument('--count', default=count, type=int,
